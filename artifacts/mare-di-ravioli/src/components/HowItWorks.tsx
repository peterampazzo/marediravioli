...
const steps = [
  {
    ...
    body: "Fill out the short signup form and tell us how many servings you'd like.",
  ...
  },
  {
    ...
    body: "100% of proceeds go directly to ocean conservation projects.",
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                <span className={`font-bold text-5xl leading-none ${step.numColor} select-none`}>
                  {step.n}
                </span>
                <span className="text-3xl">{step.emoji}</span>
              </div>
              {/* Text stacked below */}
              <h3 className="font-bold text-base text-primary mb-1 leading-snug">{step.title}</h3>
